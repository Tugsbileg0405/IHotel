...
<div class="eleven wide column">
	<form class="ui form green segment" action="<?php echo e(url('profile/pickup', $pickup->id)); ?>" method="POST">
	    ...
	    <div class="required field">
	    	<label>Нэр</label>
			<input type="text" name="name" value="<?php echo e($pickup->name); ?>">
		</div>
	    <div class="required field">
	    	<label>Нэр (Англи)</label>
			<input type="text" name="name_en" value="<?php echo e($pickup->name_en); ?>">
		</div>
	    <div class="required field">
	    	<label>Үнэ</label>
			<input type="number" name="price" value="<?php echo e($pickup->price); ?>">
		</div>
		<div class="field">
