...
<div class="eleven wide column">
    <div class="ui green segment">
    	<h4 class="ui header"><?php echo e(__('messages.Add post')); ?></h4>
    	<div class="ui divider"></div>
    	<form class="ui form" action="<?php echo e(url('profile/posts')); ?>" method="POST">
...
<script type="text/javascript">
    ...
    $('input[type=file]').change(function(){
        ...
        $.ajax({
            ...
            $(segment).removeClass('loading disabled');
            $(this).val('');
            $('<div class="ui warning message"><?php echo e(__("messages.Error occured")); ?></div>').appendTo(segment);
        });
    });
    $('.ui.form').form({
        inline : true,
