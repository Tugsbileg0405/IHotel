						...
						<div class="content">
							...
							<div class="meta">
								<div class="ui blue header">
									...
									<?php echo e(__('messages.The order number')); ?> - <?php echo e($order->number); ?>
							...
							<div class="extra">
								...
								<?php elseif($order->status == 3): ?>
									<div class="ui left floated red label"><?php echo e(__('messages.Canceled')); ?></div>
								<?php endif; ?>
							</div>
						</div>
					</div>
...
<div id="cancel-modal" class="ui modal">
	...
	<div class="content">
		<p><?php echo e(__('messages.Are you sure to cancel the order?')); ?></p>
	</div>
	<div class="actions">
