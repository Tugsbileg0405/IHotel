<?php $__env->startSection('title', 'Өрөөний үйлчилгээний ангилал'); ?>
...
<div class="eleven wide column">
	<div class="ui green segment">
	    ...
	    <form id="search-form" class="ui form" action="<?php echo e(url('profile/roomservicecategory/search')); ?>" method="POST">
		    ...
		    <a class="ui button primary" href="<?php echo e(url('profile/roomservicecategory/create')); ?>">
				...
				<tbody>
					<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td>
								<a class="ui icon button" href="<?php echo e(url('profile/roomservicecategory/'.$category->id.'/edit')); ?>">
									<i class="pencil icon"></i>
								</a>
								<a class="ui icon button open-DeleteModal" data-id="<?php echo e($category->id); ?>">
									<i class="trash icon"></i>
								</a>
								<a class="ui icon button" href="<?php echo e(url('profile/roomservice', $category->id)); ?>">
...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $('#result').on('click', '.open-DeleteModal', function() {
			...
			$('#delete-modal').modal({
				onApprove : function() {
					$('#delete-modal').find('form').attr('action', "<?php echo e(url('profile/roomservicecategory')); ?>/" + id);
