...
<div class="eleven wide column">
	<div class="ui green segment">
	    ...
	    <form id="search-form" class="ui form" action="<?php echo e(url('profile/postcategory/search')); ?>" method="POST">
		    ...
		    <a class="ui button primary" href="<?php echo e(url('profile/postcategory/create')); ?>">
...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $('#result').on('click', '.open-DeleteModal', function() {
			...
			$('#delete-modal').modal({
				onApprove : function() {
					$('#delete-modal').find('form').attr('action', "<?php echo e(url('profile/postcategory')); ?>/" + id);
