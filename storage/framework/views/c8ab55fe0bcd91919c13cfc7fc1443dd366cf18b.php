...
<div class="twelve wide column">
	<form id="create-room-service-form" class="ui form segment" action="<?php echo e(url('hotel/room/service', $hotel->id)); ?>" method="POST">
		...
		<?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="required field">
				<label><?php echo e($room->name); ?></label>
				<textarea name="room-introduction-<?php echo e($room->id); ?>" class="editor"><?php echo e($room->introduction); ?></textarea>
			</div>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		<h6 class="ui horizontal header divider ihotel-title">Бусад мэдээлэл</h6>
		<div class="field">
			<textarea name="other_info" placeholder="Нэмэлт мэдээлэл" class="editor"><?php echo e($hotel->other_info); ?></textarea>
		</div>
