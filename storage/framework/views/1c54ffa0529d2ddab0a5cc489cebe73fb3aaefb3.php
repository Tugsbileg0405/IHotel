<?php $__env->startSection('title', 'Өрөөний ангилал'); ?>

<?php $__env->startSection('content'); ?>
<div class="eleven wide column">
	<div class="ui green segment">
		<h4 class="ui header">Өрөөний ангилал</h4>
		<div class="ui divider"></div>
	    <form id="search-form" class="ui form" action="<?php echo e(url('profile/roomcategory/search')); ?>" method="POST">
		    ...
		    <a class="ui button primary" href="<?php echo e(url('profile/roomcategory/create')); ?>">
				...
				<tbody>
					<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td>
								<a class="ui icon button" href="<?php echo e(url('profile/roomcategory/'.$category->id.'/edit')); ?>">
	...
	<div id="delete-modal" class="ui modal">
		...
		<div class="content">
			<p>Хэрэв та үүнийг устгавал тус ангилалд бүртгэлтэй бүх өрөө мөн адил устах болно. Та үүнийг устгахыг зөвшөөрч байна уу?</p>
		</div>
		<div class="actions">
...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $('#result').on('click', '.open-DeleteModal', function() {
			...
			$('#delete-modal').modal({
				onApprove : function() {
					$('#delete-modal').find('form').attr('action', "<?php echo e(url('profile/roomcategory')); ?>/" + id);
