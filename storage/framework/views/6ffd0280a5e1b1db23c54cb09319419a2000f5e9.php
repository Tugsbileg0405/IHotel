					...
					<div class="people-number-left column">
						<div class="ui form">
							 <div class="people">
								...
								<input type="number" name="roomnumber" id="selectedRoom" min="1" placeholder="<?php echo e(__('messages.Rooms')); ?>">
					...
					<div class="people-number-right column">
						<div class="ui form">
							<div class="room">
								...
								<input type="number" name="peoplenumber" id="selectedPeople" min="1" placeholder="<?php echo e(__('messages.People')); ?>">
