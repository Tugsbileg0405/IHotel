...
<div class="eleven wide column">
	<div class="ui green segment">
		<h4 class="ui header"><?php echo e($category->name); ?> - үйлчилгээ</h4>
		<div class="ui divider"></div>
	    <form id="search-form" class="ui form" action="<?php echo e(url('profile/roomservice/search')); ?>" method="POST">
		    ...
		    <a class="ui button primary" href="<?php echo e(url('profile/roomservice/create', $category->id)); ?>">
				...
				<tbody>
					<?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td>
								<a class="ui icon button" href="<?php echo e(url('profile/roomservice/'.$service->id.'/edit')); ?>">
...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $('#result').on('click', '.open-DeleteModal', function() {
			...
			$('#delete-modal').modal({
				onApprove : function() {
					$('#delete-modal').find('form').attr('action', "<?php echo e(url('profile/roomservice')); ?>/" + id);
