...
<div class="eleven wide column">
	<div class="ui green segment">
		<h4 class="ui header">Буудлын ангилал</h4>
		<div class="ui divider"></div>
	    <form id="search-form" class="ui form" action="<?php echo e(url('profile/hotelcategory/search')); ?>" method="POST">
		    ...
		    <a class="ui primary button" href="<?php echo e(url('profile/hotelcategory/create')); ?>">
				...
				<tbody>
					<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td>
								<a class="ui icon button" href="<?php echo e(url('profile/hotelcategory/'.$category->id.'/edit')); ?>">
	...
	<div id="delete-modal" class="ui modal">
		...
		<div class="content">
			<p>Хэрэв та үүнийг устгавал тус ангилалд бүртгэлтэй бүх буудал мөн адил устах болно. Та үүнийг устгахыг зөвшөөрч байна уу?</p>
		</div>
		<div class="actions">
...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $('#result').on('click', '.open-DeleteModal', function() {
			...
			$('#delete-modal').modal({
				onApprove : function() {
					$('#delete-modal').find('form').attr('action', "<?php echo e(url('profile/hotelcategory')); ?>/" + id);
