...
<div class="eleven wide column">
	<form class="ui form green segment" action="<?php echo e(url('profile/comment', $comment->id)); ?>" method="POST" enctype="multipart/form-data">
		<?php echo e(csrf_field()); ?>

		<?php echo e(method_field('PUT')); ?>

		<h4 class="ui header">Сэтгэгдэл өөрчлөх</h4>
		<div class="ui divider"></div>
	    <div class="required field">
	    	<label>Нэр</label>
			<input type="text" name="name" value="<?php echo e($comment->name); ?>">
		</div>
	    <div class="required field">
	    	<label>Тайлбар</label>
			<input type="text" name="description" value="<?php echo e($comment->description); ?>">
		</div>
	    <div class="required field">
	    	<label>Агуулга</label>
			<textarea name="content"><?php echo e($comment->content); ?></textarea>
		</div>
        <div class="required field">
	    	<label>Зураг</label>
            <div class="ui segment">
                ...
                <div class="upload-zone">
		  			<div class="upload-zone-item">
		  				<img class="ui rounded image" src="<?php echo e(asset($comment->photo)); ?>">
		  			</div>
                </div>
                <input type="text" name="image" style="display: none" value="<?php echo e($comment->photo); ?>" required>
...
<script type="text/javascript">
    ...
    $('input[type=file]').change(function(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("profile/comment/update/photo")); ?>',    
