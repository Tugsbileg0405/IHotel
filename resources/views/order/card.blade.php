									...
									<div class="ui segment">
										<form id="card-form" class="ui form" action="{{ url('order/card/store') }}" method="POST">
                                            ...
                                            <div id="payment-message" class="ui hidden message">
                                                <ul class="list">
                                                    <li>{{ __('messages.Bank name: Golomt bank') }}</li>
                                                    <li>{{ __('messages.Account number: 1415101077') }}</li>
                                                    <li>{{ __('messages.Account name: iHotel LLC') }}</li>
                                                    @if (App::isLocale('en'))
                                                        <li>{{ __('messages.Account currency: USD') }}</li>
                                                    @endif
                                                    <li>{{ __('messages.Remark: Reservation number; Guest name') }}</li>
                                                </ul>
                                                <p>{{ __('messages.Transaction must be done in 48 hours (delivered by email)') }}</p>
                                            </div>
                                            <div id="payment-card">
                                                <div class="field">
                                                    <div class="ui left icon input">
