...
<div class="eleven wide column">
	<form class="ui form green segment" action="{{ url('profile/term', $term->id) }}" method="POST">
		{{ csrf_field() }}
		{{ method_field('PUT') }}
	    ...
	    <div class="required field">
	    	<label>Гарчиг</label>
			<input type="text" name="title" value="{{ $term->title }}">
		</div>
	    <div class="required field">
	    	<label>Гарчиг (Англи)</label>
			<input type="text" name="title_en" value="{{ $term->title_en }}">
		</div>
	    <div class="required field">
	    	<label>Агуулга</label>
	    	<textarea name="content">{{ $term->content }}</textarea>
		</div>
	    <div class="required field">
	    	<label>Агуулга (Англи)</label>
	    	<textarea name="content_en">{{ $term->content_en }}</textarea>
		</div>
		<div class="field">
