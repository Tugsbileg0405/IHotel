...
<div class="eleven wide column">
	<div class="ui green segment">
	    ...
	    <form id="search-form" class="ui form" action="{{ url('profile/question/search') }}" method="POST">
    		{{ csrf_field() }}
			<div class="field">
		    ...
		    <a class="ui button primary" href="{{ url('profile/question/create') }}">
...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $('#result').on('click', '.open-DeleteModal', function() {
			...
			$('#delete-modal').modal({
				onApprove : function() {
					$('#delete-modal').find('form').attr('action', "{{ url('profile/question')}}/" + id);
